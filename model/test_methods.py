...
def save_pred(y_true, y_pred, lower_bound, upper_bound):
    ...
    y_true_node = y_true[:,:,-1]
    y_pred_node = y_pred[:,:,-1]
    lower_bound_node = lower_bound[:,:,-1]
    upper_bound_node = upper_bound[:,:,-1]
    ...
    y_true_tensor_squeezed = y_true_tensor.squeeze()
    y_pred_tensor_squeezed = y_pred_tensor.squeeze()
    lower_bound_tensor_squeezed = lower_bound_tensor.squeeze()
    upper_bound_tensor_squeezed = upper_bound_tensor.squeeze()
...
# Make sure to replace y_true, y_pred, lower_bound, and upper_bound with your actual tensors.
